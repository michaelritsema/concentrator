...
_BOOTPROFILE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\202\265\030\004uuid')),
    _descriptor.FieldDescriptor(
      name='bootAnalysisGUID', full_name='BootProfile.bootAnalysisGUID', index=9,
...
_BOOTPROFILE.fields_by_name['bootAnalysisGUID'].has_options = True
_BOOTPROFILE.fields_by_name['bootAnalysisGUID']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\202\265\030\004uuid')
