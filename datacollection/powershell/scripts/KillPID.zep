...
<module>
    <name>Kill a Specific Process by PID</name>
    <description>Perform a one-time kill of a specific process by PID</description>
    <platforms>
    ...
    <parameters>
      ...
      <parameter>
			...
			<displayName>Process Identifiers</displayName>
			<description>Unique Identifier of process to kill (supports wildcards, but no extension)</description>
			<type>string</type>
			<value></value>
...
Function KillMatchingProcesses([System.Collections.ArrayList]$resultSet, [int]$processID)
{
	"Trying to get processes ID $processID"
	$processes = get-process -pid $processID -ErrorAction SilentlyContinue
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUuiMO3CCe1V58hlm26C77wGIe
# vOWgghBcMIIE0zCCA7ugAwIBAgIQGNrRniZ96LtKIVjNzGs7SjANBgkqhkiG9w0B
...
# hvcNAQkEMRYEFKYByKFQUfOn8AZ43DZIzMaogwTuMA0GCSqGSIb3DQEBAQUABIIB
# AFFYDSH5FeTlnpJhvncdLJdmJWRVlC+2UQgbpMzA5NWatoeknrbwtLrLf3NxTmZk
# ax/mIshNS5E0EizJuzZ8osEEOQIoezG/H7WnzYHhBBGyCNGpRsbtnyO4GPgRmm3+
# rpnJhwJUw1SqK0UTbkuPh6GYEvQbcd1lqwtTUCsQOmHuw500lGCbW87/OAhudIUn
# JJOWrCNP3tU6g1+JJ4ZDUP8xnavoFw/tl40XsH0SfB2GQOv5I3PYq4xnjQeOD4C7
# EsX3jOMRe2BxgB74qMrWwQDUZFV5TyvlpLg+szSYCQ6QCsg7scP9Y/fI5TqQdDgl
# T140sQ4wdAocLCnxgcxNXcM=
